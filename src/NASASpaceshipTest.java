...
public void testConstructor() {
	NASASpaceship s=new NASASpaceship(20,40,2,3,Color.gray,Color.green);
...
public void testMoveSpaceship() {
	...
	NASASpaceship spaceship=new NASASpaceship(75,100,50,0,Color.gray,Color.gray);
...
public void testSetDx() {
	NASASpaceship spaceship=new NASASpaceship(75,100,0,0,Color.gray,Color.gray);
	spaceship.setDx(2);
	spaceship.moveSpaceship();
